...
- Implemented Relative Timestamps
...
1. Add a tab bar and create a profile tab
2. Make UI look like Twitter

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/1AheERqeN7tkqvJFLz/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Had trouble implementing the user persistance
- Had touble implementing the timestamps feature
